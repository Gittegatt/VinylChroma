...
struct HardwareConfig { String boardProfile{BoardProfile::Id}; uint8_t i2cSdaPin{Hardware::I2cSdaPin},i2cSclPin{Hardware::I2cSclPin}; std::array<uint8_t,MaxSensors> sensorLedPins{Hardware::SensorLedPins}; std::array<uint8_t,MaxSensors> tcaChannels{0,1,2,3}; };
...
struct VinylConfig { bool presenceDetection{true}; uint16_t clearThreshold{350}; uint8_t requiredSensors{1}; uint16_t colorChangeThreshold{12}; float colorHoldSeconds{3.0F}; uint16_t outputSaturationPercent{100}; uint8_t outputNormalizationStrength{100}; bool darknessCutoffEnabled{false}; float darknessCutoffPercent{5.0F}; bool defaultEnabled{true}; uint16_t defaultAfterSeconds{20}; RgbColor defaultColor{255,255,255}; bool offEnabled{true}; uint16_t offAfterSeconds{60}; };
...
struct SystemConfig { bool developerMode{false}; LogLevel logLevel{LogLevel::Info}; bool otaEnabled{false}; bool browserOtaEnabled{false}; bool platformioOtaEnabled{false}; bool authenticationEnabled{false}; String authenticationUser{"admin"},authenticationPassword; };
